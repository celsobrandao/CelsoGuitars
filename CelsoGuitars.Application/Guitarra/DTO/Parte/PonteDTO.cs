...
{
    public record PonteInputDTO([Required(ErrorMessage = "A Cor deve ser informada.")] CorMetalEnum Cor,
    ...
    public record PonteUpdateDTO([Required(ErrorMessage = "O ID deve ser informado.")] Guid ID,
